...
export class AppConfig {
  static storageKeys = [ "tc-rest-token", "tc-rest-csrf", "tagsinput", "tc-url"];
  ...
  static convertObjectToConfig(storageObject: object): Config {
    const config: Config = {
      ...
      ProjectFilter: storageObject[AppConfig.storageKeys[2]] || "",
      teamCityBaseUrl: storageObject[AppConfig.storageKeys[3]] || "",
    };
